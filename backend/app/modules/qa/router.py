...
async def create_conversation(
    ...
    try:
        conv = await qa_service.create_conversation(db, int(current_user_id), body.knowledge_base_id)
...
async def ask(
    ...
    async def event_stream():
        async for event in qa_service.stream_answer(db, conv_id, user_id, body.question, debug=debug_enabled):
